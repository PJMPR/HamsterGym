...
import Lalunaa.HamsterGym.Activities;
	...
	implements IActivitiesRepository {
		...
		protected String getTrainerSql(){return "SELECT * FROM activities where TRAINER_ID=?";}
		...
		protected String getTimeSql(){return "SELECT * FROM activities where time=?";}
			...
			protected String insertSql() {
				return "INSERT INTO activities(type, TRAINER_ID, description, day, time, duration, groupSize) VALUES (?,?,?,?,?,?,?)";
			}
			
			protected String updateSql() {
				return "UPDATE activities SET (type, TRAINER_ID, description, day, time, duration, groupSize)=(?,?,?,?,?,?,?) WHERE id=?";
			}
			...
			protected void setUpdate(Activities entity) throws SQLException {
				...
				update.setInt(2, entity.getTrainer().getId());
				update.setString(3, entity.getDescription());
				update.setString(4, entity.getDay());
			...
			protected void setInsert(Activities entity) throws SQLException {
				...
				insert.setInt(2, entity.getTrainer().getId());
				insert.setString(3, entity.getDescription());
				insert.setString(4, entity.getDay());
