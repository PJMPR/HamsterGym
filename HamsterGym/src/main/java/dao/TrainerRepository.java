...
public class TrainerRepository extends RepositoryBase<Trainer> implements ITrainerRepository {
	...
	protected String getNameSql(){return "SELECT * FROM trainer where name = ?";}
	protected String getSurnameSql(){return "SELECT * FROM trainer where surname=?";}
	
	
		@Override
		protected String createTableSql() {
			return "" + "CREATE TABLE trainer("
		...
		protected String insertSql() {
			return "INSERT INTO trainer(name, surname) VALUES (?,?)";
		}
		
		protected String updateSql() {
			return "UPDATE trainer SET (name, surname)=(?,?) WHERE id=?";
		}
